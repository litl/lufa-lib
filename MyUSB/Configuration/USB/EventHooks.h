...
#define EVENTHOOKS_H
	...
	/* Configure user-application hooks here. */
		...
		#define USB_EVENT_OnVBUSDisconnect()                        { Bicolour_SetLeds(BICOLOUR_LED1_GREEN | BICOLOUR_LED2_ORANGE); }
		#define USB_EVENT_OnUSBConnect()                            { Bicolour_SetLeds(BICOLOUR_LED1_RED   | BICOLOUR_LED2_RED); }
